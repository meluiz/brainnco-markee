...
export const SavingIcon = ({ size = 24 }: IconType) => {
  return (
    <Saving width={size} height={size} viewBox='0 0 13 13' fill='none' xmlns='http://www.w3.org/2000/svg'>
...
export const SavedIcon = ({ size = 24 }: IconType) => {
  return (
    <Saved width={size} height={size} viewBox='0 0 14 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
